...
export default function AttractionPage() {
  ...
  const attractions: Attraction[] = [
    { 
      ...
      longDescription: "A vibrant, centuries-old market showcasing Amazonian products, local cuisine, and traditional crafts.",
      ...
      entryFee: "Free",
      sustainabilityInfo: "Promotes local products and traditional livelihoods, helping preserve Amazonian culture and biodiversity."
    },
    { 
      id: 2, 
      ...
      image: "https://images.unsplash.com/photo-1548277687-13c34c61df40?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80", 
